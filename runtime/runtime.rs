...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: { ::sp_runtime::RuntimeString::Borrowed("subground") },
    impl_name: { ::sp_runtime::RuntimeString::Borrowed("subground") },
    authoring_version: 1,
    spec_version: 100,
    impl_version: 1,
...
const _: () = {
    impl ::scale_info::TypeInfo for Runtime {
        ...
        fn type_info() -> ::scale_info::Type {
            ::scale_info::Type::builder()
                .path(::scale_info::Path::new("Runtime", "subground_runtime"))
                .type_params(::alloc::vec::Vec::new())
                .docs(&[])
...
const _: () = {
    impl ::scale_info::TypeInfo for Event {
        ...
        fn type_info() -> ::scale_info::Type {
            ::scale_info::Type::builder()
                .path(::scale_info::Path::new("Event", "subground_runtime"))
                .type_params(::alloc::vec::Vec::new())
                .docs(&[])
                .variant(
...
pub type AllPalletsWithSystem = ((
    ...
    (
        ...
        (
            Timestamp,
            (Aura, (Grandpa, (Balances, (TransactionPayment, (Sudo,))))),
        ),
    ),
));
/// All pallets included in the runtime as a nested tuple of types.
    ...
    for Call
{
    ...
    fn get_module_names() -> &'static [&'static str] {
        &["System", "Timestamp", "Grandpa", "Balances", "Sudo"]
    }
